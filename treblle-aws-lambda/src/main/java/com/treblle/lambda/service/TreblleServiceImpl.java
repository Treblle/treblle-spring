package com.treblle.lambda.service;
...
public class TreblleServiceImpl extends AbstractTreblleService {
    ...
    private static final String SDK_NAME = "java-lambda";

    public TreblleServiceImpl(TreblleProperties treblleProperties, ObjectMapper objectMapper) {
